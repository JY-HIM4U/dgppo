...
class VMASCollaborativeTransportLidar(MultiAgentEnv):
    ...
    def step(
        ...
        world = World(x_semidim=self.area_size, y_semidim=self.area_size, contact_margin=6e-3, substeps=5, collision_force=500, real_num_agents=env_state.real_num_agents, num_agents=self.num_agents)
